...
func (e *ERC721EnumerableContract) TokenOfOwnerByIndex(ctx context.Context, owner common.Address, index int64) (tokenID int64, err error) {
	//TODO implement me
	panic("implement me")
}

func (e *ERC721EnumerableContract) TotalSupply(ctx context.Context) (total int64, err error) {
	//TODO implement me
	panic("implement me")
}
